...
> Whereas CCCC 198 has an unusually low proportion of <þ> to <ð> as a whole, its copy of Blickling XIII is an outlier even here, with a thorn-to-eth ratio of just 0.02 against an ECHOE corpus mean of 3 (see the statistics for [ECHOE 48.54](https://echoe.uni-goettingen.de/#/versions/compare/48.54) and neighboring items).
